...
public class CritterFrame extends JFrame {
    ...
    public CritterFrame(int width, int height, double scale) {
        ...
        // rounded scaled size
        myFontSize = (int) (12 * scale + 0.5);

        UIManager.put("Button.font", new FontUIResource("Dialog", Font.BOLD, myFontSize));
        ...
        myPicture = new CritterPanel(myModel, myFontSize);
    ...
    private void constructSouth() {
        ...
        JLabel jl1 = new JLabel("slow");
        jl1.setFont(new Font("Dialog", Font.BOLD, myFontSize));
        p.add(jl1);
        p.add(slider);
        JLabel jl2 = new JLabel("fast");
        jl2.setFont(new Font("Dialog", Font.BOLD, myFontSize));
        p.add(jl2);
        Dimension d = slider.getPreferredSize();
        slider.setPreferredSize(new Dimension(d.width+75,d.height));
        ...
        // add 5000 button
        JButton b6 = new JButton("next 5000");
